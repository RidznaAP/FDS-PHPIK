...
// ══════════════════════════════════════════════════════════════
// 4. NOTIFICATION POLLING (Visibility API-aware)
// ══════════════════════════════════════════════════════════════
// Note: Fungsi ini hanya dipanggil dari app.blade.php setelah
//       kondisi @auth diverifikasi. Fungsi sendiri bersifat murni JS.
...
function initNotifPolling(notifUrl) {
    ...
    document.addEventListener('visibilitychange', function() {
        if (document.visibilityState === 'visible') {
            updateNotifBadge(); // Fetch langsung saat tab kembali aktif
            startPolling();
        } else {
            stopPolling(); // Hemat resource saat tab tidak terlihat
        }
    });
