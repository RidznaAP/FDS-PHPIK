        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between py-3">
                <div class="d-flex align-items-center gap-2">
                    <div class="bg-orange text-white rounded-2 d-flex align-items-center justify-content-center" style="width:32px;height:32px;">
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div class="flex-grow-1 min-w-0">
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                ...
                                @if(!$notif->dibaca)
                                    <span class="badge bg-blue" style="width:8px;height:8px;padding:0;border-radius:50%;flex-shrink:0;"></span>
                                @endif
                            </div>
                        ...
                        <form action="{{ route('notifikasi.hapus', $notif->id) }}" method="POST" class="flex-shrink-0">
                            @csrf @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-ghost-secondary btn-icon" title="Hapus notifikasi ini">
                                <i class="ti ti-x"></i>
                            </button>
                        </form>
                    </div>
